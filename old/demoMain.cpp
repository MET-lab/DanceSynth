...
#define MARK_FILE_PATH      "mark_script.asc"
#define DANCE_FILE_PATH      "dance_script.asc"
...
int main(void)
{
    ...
    while(1)
    {
        ...
        case MARK:
            if(LinuxActionScript::m_is_running == 0)
                LinuxActionScript::ScriptStart(MARK_FILE_PATH);
            break;
        case ROBOT:
            /*if(Action::GetInstance()->IsRunning() == 0) {
            ...
            */
            if(LinuxActionScript::m_is_running == 0) {
              ...
              LinuxActionScript::ScriptStart(DANCE_FILE_PATH);
            }
            //}
            break;
        case VISION:
