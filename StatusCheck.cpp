...
void StatusCheck::Check(CM730 &cm730)
{
    ...
    if(m_old_btn & BTN_MODE)
    {
        ...
        else if(m_cur_mode == MARK)
        {
            cm730.WriteByte(CM730::P_LED_PANNEL, 0x01|0x02, NULL);
            LinuxActionScript::PlayMP3("../../../Data/mp3/Headstand.mp3");
        }
        else if(m_cur_mode == ROBOT)
        {
            cm730.WriteByte(CM730::P_LED_PANNEL, 0x02|0x04, NULL);
            LinuxActionScript::PlayMP3("../../../Data/mp3/Robot_Rock.mp3");
        }
    }
    ...
    if(m_old_btn & BTN_START)
    {
        if(m_is_started == 0)
        {
            ...
            else if(m_cur_mode == ROBOT)
            {
                ...
                MotionManager::GetInstance()->SetEnable(true);
                m_is_started = 1;
                //LinuxActionScript::PlayMP3("../../../Data/mp3/Demo_Emotion_comp.mp3");
